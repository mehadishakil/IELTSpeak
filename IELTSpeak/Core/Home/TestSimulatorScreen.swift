////
////  TestSimulatorScreen.swift
////  IELTSpeak
////
////  Created by Mehadi Hasan on 11/7/25.
////
//
//
//
...
//                Spacer()
//
//                // Settings/Question toggle
//                if currentPhase == .testing {
//                    Button(action: { showQuestions.toggle() }) {
//                        ZStack {
//                            Circle()
//                                .fill(Color.white.opacity(0.2))
//                                .frame(width: 40, height: 40)
//
//                            Image(systemName: showQuestions ? "eye.slash" : "eye")
//                                .font(.title2)
//                                .foregroundColor(.white)
//                        }
//                    }
...
//            // Part progress
//            HStack {
//                ForEach(1...3, id: \.self) { partNum in
//                    HStack {
//                        Circle()
//                            .fill(partNum <= currentPart ? Color.blue : Color.gray.opacity(0.3))
//                            .frame(width: 30, height: 30)
//                            .overlay(
//                                Text("\(partNum)")
//                                    .font(.caption)
//                                    .fontWeight(.semibold)
//                                    .foregroundColor(partNum <= currentPart ? .white : .gray)
//                            )
//
//                        if partNum < 3 {
//                            Rectangle()
...
//            // Current part info
//            VStack(spacing: 4) {
//                Text(currentTestPart.title)
//                    .font(.headline)
//                    .fontWeight(.semibold)
//                    .foregroundColor(.primary)
//
//                Text("Duration: \(currentTestPart.duration)")
//                    .font(.caption)
//                    .foregroundColor(.secondary)
//            }
//        }
...
//            if currentTestPart.questions.count > 1 {
//                Text("Question \(currentQuestion + 1) of \(currentTestPart.questions.count)")
//                    .font(.caption)
//                    .foregroundColor(.secondary)
//            }
//
...
//            .frame(maxHeight: 200)
//
//            // Special instructions for Part 2
//            if currentPart == 2 {
//                VStack(spacing: 8) {
...
//                        .font(.system(size: 60))
//                        .foregroundColor(.blue)
//                        .scaleEffect(showWaveform ? 1.2 : 1.0)
//                        .animation(.easeInOut(duration: 0.8).repeatForever(autoreverses: true), value: showWaveform)
//
//                    Text("Listening...")
//                        .font(.title2)
//                        .fontWeight(.semibold)
...
//                            .frame(width: 4, height: CGFloat(waveformData[index] * 50 + 10))
...
//
//            // Instructions
//            Text(isRecording ? "Tap to stop recording" : "Tap to start recording your answer")
//                .font(.caption)
//                .foregroundColor(.secondary)
//                .padding(.bottom, 20)
//        }
...
//                            .scaleEffect(isRecording ? 1.0 : 1.2)
...
//                    }
//                    
//                    Text(isRecording ? "You're speaking" : "AI Examiner")
//                        .font(.headline)
//                        .fontWeight(.semibold)
//                        .foregroundColor(.primary)
//
//                }
//                
//                // AI waveform (when AI is speaking)
...
//                                    .frame(width: 3, height: CGFloat(waveformData[index] * 30 + 5))
//                                    .animation(.easeInOut(duration: 0.1), value: waveformData[index])
//                            }
//                        }
//                        .frame(height: 40)
...
//                }
//                
//                // Question display when showQuestions is enabled
//                if showQuestions && !currentQuestionText.isEmpty {
//                    VStack(spacing: 12) {
//                        // Question text
//                        ScrollView {
//                            Text(currentQuestionText)
...
//                        if currentPart == 2 {
//                            VStack(spacing: 4) {
//                                Text("Preparation: 1 minute • Speaking: 2 minutes")
//                                    .font(.caption)
//                                    .foregroundColor(.orange)
//                                    .fontWeight(.medium)
//                            }
...
//                                        .fill(partNumber == currentPart ? Color.white.opacity(0.8) : Color.clear)
//                                        .frame(height: 2)
//                                )
//                            
...
//                                
//                                Text(testQuestions[partNumber - 1].title)
//                                    .font(.caption2)
//                                    .foregroundColor(.secondary)
//                                    .multilineTextAlignment(.center)
//                                    .lineLimit(2)
...
//                    }
//                    
//                    Text(isUserSpeaking ? "Speaking..." : "You")
//                        .font(.subheadline)
//                        .fontWeight(.semibold)
//                        .foregroundColor(.primary)
//                    
...
//                }
//                
//                // User waveform (when user is speaking)
//                if isUserSpeaking {
//                    HStack(spacing: 2) {
//                        ForEach(0..<userWaveformData.count, id: \.self) { index in
//                            RoundedRectangle(cornerRadius: 2)
//                                .fill(Color.green.opacity(0.7))
//                                .frame(width: 6, height: CGFloat(userWaveformData[index] * 40 + 8))
...
//        }
//        .onAppear {
//            // Auto-start the conversation flow
...
//        generateWaveformData()
//        
//        // After 3 seconds, simulate user starting to speak
...
//        }
//        
//        // Auto-advance after speaking time
